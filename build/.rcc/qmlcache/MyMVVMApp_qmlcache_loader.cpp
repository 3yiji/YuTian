...
int QT_MANGLE_NAMESPACE(qInitResources_qmlcache_MyMVVMApp)() {
    ::unitRegistry();
    return 1;
}
Q_CONSTRUCTOR_FUNCTION(QT_MANGLE_NAMESPACE(qInitResources_qmlcache_MyMVVMApp))
int QT_MANGLE_NAMESPACE(qCleanupResources_qmlcache_MyMVVMApp)() {
    return 1;
}
